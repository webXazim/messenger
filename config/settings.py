...
# Support Chat staged rollout flags. Defaults keep new operational modules hidden
# until migrations, workers, backfills, and regression checks pass.
SUPPORT_WEBSITES_V2_ENABLED = env_bool("SUPPORT_WEBSITES_V2_ENABLED", False)
SUPPORT_TEAMS_ENABLED = env_bool("SUPPORT_TEAMS_ENABLED", False)
SUPPORT_ROUTING_ENABLED = env_bool("SUPPORT_ROUTING_ENABLED", False)
SUPPORT_KNOWLEDGE_V2_ENABLED = env_bool("SUPPORT_KNOWLEDGE_V2_ENABLED", False)
SUPPORT_LIFECYCLE_V2_ENABLED = env_bool("SUPPORT_LIFECYCLE_V2_ENABLED", False)
SUPPORT_SLA_V2_ENABLED = env_bool("SUPPORT_SLA_V2_ENABLED", False)
SUPPORT_ANALYTICS_V2_ENABLED = env_bool("SUPPORT_ANALYTICS_V2_ENABLED", False)
SUPPORT_AUTOMATIONS_ENABLED = env_bool("SUPPORT_AUTOMATIONS_ENABLED", False)
SUPPORT_SECURITY_V2_ENABLED = env_bool("SUPPORT_SECURITY_V2_ENABLED", False)
...
FIREBASE_PUSH_REQUIRED = env_bool("FIREBASE_PUSH_REQUIRED", False)
...
SUPPORT_INVITATION_EMAIL_ASYNC = env_bool("SUPPORT_INVITATION_EMAIL_ASYNC", False)
...
EMAIL_VERIFY_OTP_TTL_SECONDS = env_int("EMAIL_VERIFY_OTP_TTL_SECONDS", 600)
EMAIL_VERIFY_OTP_MAX_ATTEMPTS = env_int("EMAIL_VERIFY_OTP_MAX_ATTEMPTS", 5)
...
MESSAGE_EDIT_WINDOW_SECONDS = env_int("MESSAGE_EDIT_WINDOW_SECONDS", 15 * 60)
...
CHAT_DATA_PLANE_JOB_BATCH_SIZE = max(1, min(500, env_int("CHAT_DATA_PLANE_JOB_BATCH_SIZE", 150)))
CHAT_DATA_PLANE_JOB_LEASE_SECONDS = max(30, env_int("CHAT_DATA_PLANE_JOB_LEASE_SECONDS", 120))
CHAT_DATA_PLANE_JOB_RETENTION_DAYS = max(1, env_int("CHAT_DATA_PLANE_JOB_RETENTION_DAYS", 7))
SUPPORT_DATA_PLANE_JOB_BATCH_SIZE = max(1, min(500, env_int("SUPPORT_DATA_PLANE_JOB_BATCH_SIZE", 100)))
SUPPORT_DATA_PLANE_JOB_LEASE_SECONDS = max(30, env_int("SUPPORT_DATA_PLANE_JOB_LEASE_SECONDS", 120))
SUPPORT_DATA_PLANE_JOB_RETENTION_DAYS = max(1, env_int("SUPPORT_DATA_PLANE_JOB_RETENTION_DAYS", 7))
